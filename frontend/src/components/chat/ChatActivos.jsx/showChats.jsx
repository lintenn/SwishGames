...
export const Chats = ({ users, mensajesBuscar, receptor, group, setResponder, setReceptor, setGroup, user, setMensaje, setConexion, myGroups, setConfigurationGroups, mensajes, recienEnviado }) => {
